...
public class ClearableEditText extends RelativeLayout {
	...
	private void init(AttributeSet attrs) {
		...
		if (attrs != null) {
			TypedArray attrsArray = getContext().obtainStyledAttributes(attrs,R.styleable.ClearableEditText);
			editText.setInputType(attrsArray.getInt(R.styleable.ClearableEditText_android_inputType, InputType.TYPE_CLASS_TEXT));
